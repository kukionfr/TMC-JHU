...
def ims2omecstack(ims,outputfilepath,compression):
    imobjs = []
...
if __name__=='__main__':
    src = r'Z:\stephen_eric_3D_vis\data\labeled_annotation_map_by_class'
    ...
    ims2omecstack(pth_ims, pth_ometiff, compression='none')
    # if not os.path.exists(pth_ometiff): ims2omecstack(pth_ims,pth_ometiff,compression='none')
